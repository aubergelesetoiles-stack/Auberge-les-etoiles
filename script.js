...
const animateElements = document.querySelectorAll(
    '.room-card, .review-card, .gallery-item, .about-content, .contact-content'
);
...
galleryItems.forEach(item => {
    item.addEventListener('click', () => {
        // Here you could add a lightbox functionality
...
// Scroll reveal animation for hero elements
...
console.log('Auberge les Étoiles - Website loaded successfully! ⭐');
